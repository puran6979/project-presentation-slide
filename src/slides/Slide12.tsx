...
const MqIcon = () => <SVGWrap><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /><path d="M8 10h8" /><path d="M8 14h4" /></SVGWrap>;
...
const SharepointIcon = () => <SVGWrap><path d="M4 4h16v16H4z" /><circle cx="12" cy="12" r="4" /></SVGWrap>;
const S3Icon = () => <SVGWrap><rect x="2" y="2" width="20" height="20" rx="2" ry="2" /><path d="M2 12h20" /><path d="M12 2v20" /></SVGWrap>;
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            width: "100%",
            height: "100%",
            background: "linear-gradient(90deg, rgba(254,243,199,0.3), rgba(254,226,226,0.3))",
            borderRadius: 24,
        ...
        >
          <div style={{ position: "absolute", top: -18, left: "50%", transform: "translateX(-50%)", fontSize: 10, fontWeight: 800, color: "#D97706" }}>Service Layer</div>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            width: "100%",
            height: "100%",
            background: "linear-gradient(90deg, rgba(204,251,241,0.4), rgba(220,252,231,0.4))",
            borderRadius: 24,
        ...
        >
          <div style={{ position: "absolute", bottom: -18, left: "50%", transform: "translateX(-50%)", fontSize: 10, fontWeight: 800, color: "#059669" }}>Storage Layer</div>
        </motion.div>
        ...
        {/* Beams */}
        <GridBeam containerRef={containerRef} fromRef={sharepointRef} toRef={webhookRef} gradientStartColor={NS.sharepoint.color} gradientStopColor={NS.webhook.color} delay={1.0} />
        <GridBeam containerRef={containerRef} fromRef={webhookRef} toRef={storageRef} gradientStartColor={NS.webhook.color} gradientStopColor={NS.storage.color} delay={1.2} />
        <GridBeam containerRef={containerRef} fromRef={storageRef} toRef={mqRef} gradientStartColor={NS.storage.color} gradientStopColor={NS.mq.color} delay={1.4} />
        <GridBeam containerRef={containerRef} fromRef={mqRef} toRef={ingestRef} gradientStartColor={NS.mq.color} gradientStopColor={NS.ingestion.color} delay={1.6} />
        <GridBeam containerRef={containerRef} fromRef={ingestRef} toRef={embedRef} gradientStartColor={NS.ingestion.color} gradientStopColor={NS.embedding.color} delay={1.8} />
        
        {/* Diagonals */}
        <GridBeam containerRef={containerRef} fromRef={storageRef} toRef={s3Ref} gradientStartColor={NS.storage.color} gradientStopColor={NS.s3.color} delay={2.0} />
        <GridBeam containerRef={containerRef} fromRef={s3Ref} toRef={ingestRef} gradientStartColor={NS.s3.color} gradientStopColor={NS.ingestion.color} delay={2.2} />

        {/* Bidirectional Beams */}
        <GridBeam containerRef={containerRef} fromRef={embedRef} toRef={aiRef} gradientStartColor={NS.embedding.color} gradientStopColor={NS.ai.color} delay={2.4} startYOffset={-16} endYOffset={-16} />
        <GridBeam containerRef={containerRef} fromRef={aiRef} toRef={embedRef} gradientStartColor={NS.ai.color} gradientStopColor={NS.embedding.color} delay={2.6} startYOffset={16} endYOffset={16} />

        <GridBeam containerRef={containerRef} fromRef={aiRef} toRef={frontendRef} gradientStartColor={NS.ai.color} gradientStopColor={NS.frontend.color} delay={2.8} startXOffset={-16} endXOffset={-16} />
        <GridBeam containerRef={containerRef} fromRef={frontendRef} toRef={aiRef} gradientStartColor={NS.frontend.color} gradientStopColor={NS.ai.color} delay={3.0} startXOffset={16} endXOffset={16} />

        <GridBeam containerRef={containerRef} fromRef={embedRef} toRef={qdrantRef} gradientStartColor={NS.embedding.color} gradientStopColor={NS.qdrant.color} delay={3.2} startXOffset={-16} endXOffset={-16} />
        <GridBeam containerRef={containerRef} fromRef={qdrantRef} toRef={embedRef} gradientStartColor={NS.qdrant.color} gradientStopColor={NS.embedding.color} delay={3.4} startXOffset={16} endXOffset={16} />
