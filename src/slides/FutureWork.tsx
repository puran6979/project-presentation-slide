...
const ACHIEVEMENTS = [
  {
    ...
    enDesc:
      "The HybridChunker + Docling pipeline preserves original structure during extraction and greatly reduces context fragmentation.",
    color: "#10B981",
    rgb: "16,185,129",
  },
  {
    ...
    enDesc:
      "77% faithfulness, 97% task completion, and 99% tool correctness — outperforming baseline RAG.",
    color: "#7C3AED",
    rgb: "124,58,237",
  },
  {
    ...
    enDesc:
      "A seven-service microservices architecture with JWT auth, SSE streaming, RabbitMQ synchronization, and multilingual support via BGE-M3.",
    color: "#3B82F6",
    rgb: "59,130,246",
  },
];
...
const FUTURE_WORK = [
  {
    ...
    desc: "เพิ่มการสืบค้นโครงข่ายความสัมพันธ์เพื่อใช้งานร่วมกับความคล้ายคลึงของความหมาย ยกระดับการค้นพบองค์ความรู้ภายในองค์กร",
    enDesc:
      "Add relationship-aware retrieval that combines graph traversal with semantic similarity to improve enterprise knowledge discovery.",
    color: "#8B5CF6",
    rgb: "139,92,246",
  },
  {
    title: "Full Azure AD SSO Integration",
    desc: "ทำระบบ Single Sign-On แบบ OIDC ผ่าน Passport-Azure-AD ให้สมบูรณ์ (ออกแบบสถาปัตยกรรมไว้แล้วรอการติดตั้ง)",
    enDesc:
      "Complete OIDC-based single sign-on through Passport-Azure-AD; the architecture is already designed and ready for rollout.",
    color: "#3B82F6",
    rgb: "59,130,246",
  },
  {
    title: "AI Guardrails Layer",
    desc: "ป้องกันการถูกโจมตีด้วย Prompt Injection และตัวกรองคัดกรองคำตอบที่ไม่เหมาะสม",
    enDesc:
      "Add defenses against prompt injection and filters for unsafe or inappropriate responses.",
    color: "#F59E0B",
    rgb: "245,158,11",
  },
  {
    title: "Multi-channel Integration",
    desc: "เชื่อมต่อกับแอปพลิเคชันสนทนา เช่น LINE หรือ Microsoft Teams",
    enDesc: "Integrate with chat platforms such as LINE or Microsoft Teams.",
    color: "#10B981",
    rgb: "16,185,129",
  },
];
          ...
          {ACHIEVEMENTS.map((a, i) => (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  <ThaiText en={a.enDesc}>{a.desc}</ThaiText>
                </p>
              </div>
            </motion.div>
          ))}
            ...
            {FUTURE_WORK.map((fw, i) => (
              ...
              >
                ...
                <div>
                  ...
                  >
                    <ThaiText en={fw.enDesc}>{fw.desc}</ThaiText>
                  </div>
                </div>
              </motion.div>
            ))}
